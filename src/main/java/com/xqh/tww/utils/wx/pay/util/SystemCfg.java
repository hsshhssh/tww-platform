...
public class SystemCfg {
    ...
    private String  appId = "wx254ab70c702ef64b";
    //受理商ID，身份标识
    private String  mchid = "1399562302";
    //微信操作人
    private String  weChatOpUserId     = "1399562302"; //默认为商户
    //商户支付密钥Key。审核通过后，在微信发送的邮件中查看
    private String   weChatPaykey       = "1fadfs8023423jkosdviusovjs234232";
    //商户支付密钥Key。审核通过后，在微信发送的邮件中查看
    ...
    //异步回调地址
    private String   notifyUrl      = "http://inf.dlzpt.com/pay/wx/notify";
    //web回调地址
    private String   webNotifyUrl   = "";
    //支付宝结果回调
    private String   alipayNotifyUrl = "";
    //微信获取预订单地址
    private String   prepayIdRequestUrl = "https://api.mch.weixin.qq.com/pay/unifiedorder";
    //微信查询订单结果地址
